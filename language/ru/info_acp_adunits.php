...
$lang = array_merge($lang, array(
	...
	'ADUNITS_EXCLUDE'					=> 'Исключения',
	'ACP_ADUNITS_EXCLUDE'				=> 'Не отображать на страницах',
	'ACP_ADUNITS_EXCLUDE_EXPLAIN'		=>'Для выбора нескольких страниц используйте соответствующую для вашего компьютера и браузера комбинацию мыши и клавиатуры. Исключённые страницы отображаются на синем фоне.'
));
